...
SAVED_WEIGHT = os.path.join(PARENT_FOLDER, 'ver2_result')
...
parameters['conv1_layer1'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'conv1_layer1_weights.csv'))['Weight']).reshape(conv1_layer1_shape)
parameters['conv1_layer2'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'conv1_layer2_weights.csv'))['Weight']).reshape(conv1_layer2_shape)
parameters['conv2_layer1'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'conv2_layer1_weights.csv'))['Weight']).reshape(conv2_layer1_shape)
parameters['conv2_layer2'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'conv2_layer2_weights.csv'))['Weight']).reshape(conv2_layer2_shape)
parameters['fc_layer1_w'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'fc_layer1_weights.csv'))['Weight']).reshape(fc_layer1_w_shape)
parameters['fc_layer1_b'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'fc_layer1_biases.csv'))['Weight']).reshape(fc_layer1_b_shape)
parameters['fc_layer2_w'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'fc_layer2_weights.csv'))['Weight']).reshape(fc_layer2_w_shape)
parameters['fc_layer2_b'] = np.array(pd.read_csv(os.path.join(SAVED_WEIGHT, 'fc_layer2_biases.csv'))['Weight']).reshape(fc_layer2_b_shape)

# parameters['conv1_layer1'] = np.random.rand(2,1,input_units,depth1)
# parameters['conv1_layer2'] = np.random.rand(2,1,depth1,depth2)
# parameters['conv2_layer1'] = np.random.rand(1,2,input_units,depth1)
# parameters['conv2_layer2'] = np.random.rand(1,2,depth1,depth2)
# parameters['fc_layer1_w']  = np.random.rand(3*4*depth1*2+ 4*2*depth2*2 + 3*3*depth2*2,hidden_units)
# parameters['fc_layer1_b']  = np.random.rand(hidden_units)
# parameters['fc_layer2_w']  = np.random.rand(hidden_units,output_units)
# parameters['fc_layer2_b']  = np.random.rand(output_units)
